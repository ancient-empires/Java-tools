...
for (idx = 0; idx < argc; idx++); //ne pas effacer, sinon ça foire.
printf("\n Ancient Empires II language file text converter v0.1b\n\n"); //titre du programme

if(idx<2) help(); //CHECK1=vérifie qu'il y a bien au moins 3 parametres
...
//Evincer éventuellement le foutu EFBB BF en en-tête qui sort d'on se sait où...
o1 = getc(fo);
o2 = getc(fo);
o3 = getc(fo);
