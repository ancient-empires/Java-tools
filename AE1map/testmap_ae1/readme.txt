	...
	=====================================
	Ancient Empires - Map tester batch
	=====================================

This pack is made to test quickly a AE1 map from the AE1 map editor.
...
* Copy a AE1 game .jar file into the temp\ folder and rename it to: temp\temp.jar
